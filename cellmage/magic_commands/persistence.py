...
def export_conversation_to_markdown(
    ...
    try:
        ...
        if total_tokens_in > 0 or total_tokens_out > 0:
            md_content.append(f"Total Tokens: {total_tokens_in + total_tokens_out} (Input: {total_tokens_in}, Output: {total_tokens_out})\n")
...
def delete_sqlite_conversation(
    conversation_id: str,
    db_path: Optional[str] = None
) -> bool:
    """
