...
class ConversationManager:
    ...
    def _init_storage(self, db_path: Optional[str] = None) -> None:
        ...
        if self.storage_type == 'sqlite':
            ...
            self.logger.warning(f"Storage type '{self.storage_type}' not supported. Using SQLite instead.")
            self.store = SQLiteStore(db_path)
    ...
    def delete_conversation(self, conversation_id: str) -> bool:
        ...
        try:
            ...
            is_current = (
                ...
                f"sqlite://{self.current_conversation_id}" == conversation_id
            )
    ...
    def _save_current_conversation(self) -> Optional[str]:
        ...
        try:
            ...
            save_path = self.store.save_conversation(
                ...
                metadata=metadata,
                filename=self.current_conversation_id
            )
